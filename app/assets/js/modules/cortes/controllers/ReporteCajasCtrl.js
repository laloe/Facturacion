function ReporteCajasCtrl($state, sessionFactory, menuFactory, $rootScope, reportesFactory, $filter, GlobalService, ngNotify) {
	var vm = this;
...
angular
	.module('app')
	.controller('ReporteCajasCtrl', ReporteCajasCtrl);
