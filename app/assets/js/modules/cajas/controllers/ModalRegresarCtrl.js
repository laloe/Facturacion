angular
	.module('app')
	.controller('ModalRegresarCtrl', ModalRegresarCtrl);

function ModalRegresarCtrl($uibModalInstance, cajasFactory, items, $rootScope, ngNotify) {
	var vm = this;
	vm.cancel = cancel;
