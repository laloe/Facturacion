angular
	.module('app')
	.factory('desgloseFactory', desgloseFactory);


function desgloseFactory($http, $q, GlobalService, sessionFactory) {
	var factory = {};
	var paths = {
	...
	factory.checarDesglose = function(usuario, fecha) {
		...
		$http.post(GlobalService.getUrl() + paths.checarDesglose, JSON.stringify(Parametros), config).success(function(data) {
	...
	factory.busquedaDesglose = function(seleccion, usuario, fecha) {
		...
		$http.post(GlobalService.getUrl() + paths.busquedaDesglose, JSON.stringify(Parametros), config).success(function(data) {
			deferred.resolve(data);
		}).error(function(data) {
			deferred.reject(data);
		});
	...
	factory.agregarDesglose = function(obj) {
		...
		$http.post(GlobalService.getUrl() + paths.agregarDesglose, JSON.stringify(Parametros), config).success(function(data) {
			deferred.resolve(data);
		}).error(function(data) {
			deferred.reject(data);
		});
	...
	factory.consultaDesglose = function(consecutivo) {
		...
		$http.post(GlobalService.getUrl() + paths.consultaDesglose, JSON.stringify(Parametros), config).success(function(data) {
			deferred.resolve(data);
		}).error(function(data) {
			deferred.reject(data);
		});
	...
	factory.updateDesglose = function(obj) {
		...
		$http.post(GlobalService.getUrl() + paths.updateDesglose, JSON.stringify(Parametros), config).success(function(data) {
			deferred.resolve(data);
		}).error(function(data) {
			deferred.reject(data);
		});
	...
	factory.deleteDesglose = function(consecutivo) {
		...
		$http.post(GlobalService.getUrl() + paths.deleteDesglose, JSON.stringify(Parametros), config).success(function(data) {
			deferred.resolve(data);
		}).error(function(data) {
			deferred.reject(data);
		});
	...
	factory.validarCajero = function(clave, user, pass) {
		...
		$http.post(GlobalService.getUrl() + paths.validarCajero, JSON.stringify(Parametros), config).success(function(data) {
			deferred.resolve(data);
		}).error(function(data) {
			deferred.reject(data);
		});
